...
// p05버전, 260109 수정, sbc 켜져야만 넘어가게함. 마네킹 넘어갓다가 올라오는거 1.5초
// 마네킹 올라오는게 DIR LOW, 내려가는게 HIGH
// Hit 판정 추가 안됨
...
#define LIMIT_DOWN      6   // down switch
#define LIMIT_UP        5   // up switch
#define MNQ1            10
#define MNQ2            11
#define MNQ3            12
#define MNQ_DIR         19
...
// ++++++++++ 알람 리셋 추가 ++++++++++
#define L_ALARM_RESET   21  // pcb 표기 = vol
#define R_ALARM_RESET   27  // pcb 표기 = accel
...
//P05L & P05 ROBOT SETTING
#define TRACK_WIDTH                     0.782
#define WHEEL_RADIOUS                   0.19
#define PPR                             100
